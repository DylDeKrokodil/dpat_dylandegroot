...
public sealed class FsmApplication
{
    ...
    public FsmApplication(
        ...
        : this(
            ...
            renderer,
            userInterface,
            new FsmInputFileResolver(),
            new ConsoleSimulationRunner(userInterface))
    {
    }
    ...
    public int Run(string[] args)
    {
        ...
        var inputFilePath = options.InputFilePath ?? _userInterface.ReadInputFilePath();
        ...
        try
        {
            var diagram = _parser.ParseFile(_inputFileResolver.Resolve(inputFilePath));
